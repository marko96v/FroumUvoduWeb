		...
		<div class="container" style="margin-top: 10px">
			...
			<div class="panel-group" id="accordion">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Podaci o korisniku</a>
						</h4>
					</div>
						...
						<div class="panel-body">
								...
								<fieldset>
										<form>
											...
											<div class="form-group form-group-sm selectContainer">
												<label>Postovi po stranici:</label>
											...
											<button type="submit" class="btn btn-default" id="change_details">Sacuvaj</button>
							...
							<div class="user_password well well-sm">
								...
								<fieldset>
										<form>
											<div class="form-group form-group-sm">
											    <label for="pwd">Stara sifra:</label>
												<span class="glyphicon glyphicon-asterisk" style="float: right;font-size:10px;"></span>
											...
											<button type="submit" class="btn btn-default" id="change_pass">Sacuvaj</button>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Clanovi</a>
						</h4>
					</div>
								...
								<table class="table forum">
									...
									<thead>
										<tr>
											...
											<th class="cell-stat text-center hidden-xs hidden-sm black">Korisnicko Ime</th>
											<th class="cell-stat text-center hidden-xs hidden-sm black">Ime</th>
											<th class="cell-stat text-center hidden-xs hidden-sm black">Prezime</th>
											<th class="cell-stat text-center hidden-xs hidden-sm black">Datum Registracije</th>
											<th class="cell-stat text-center hidden-xs hidden-sm black">Ban-ovan</th>
											<th class="cell-stat text-center hidden-xs hidden-sm black">Aktivan</th>
											<th class="cell-stat text-center hidden-xs hidden-sm black">Uradi</th>
