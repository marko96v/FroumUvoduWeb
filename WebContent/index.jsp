		...
		<div class="container" style="margin-top: 10px">
			...
			<div class="page-header page-heading">
				...
				<div class="pull-right" id="logged_in" <%= logged_in %>>
					...
					<button class="btn-default btn-sm" id="btn_panel">Upravljanje Nalogom</button>
			...
			<table class="table forum table-hover">
				...
				<thead>
					...
					<tr>
						...
						<th>
							<h3 style="display: inline;">Javni</h3> &nbsp;
				...
				<thead>
					<tr>
						<th class="cell-stat"></th>
						<th>
							<h3 style="display: inline;">Otvoreni</h3> &nbsp;
				...
				<thead>
					<tr>
						<th class="cell-stat"></th>
						<th>
							<h3 style="display: inline;">Zatvoreni</h3> &nbsp;
					 ...
					 <form>
						  ...
						  <button type="submit" class="btn btn-default btn_black_win_container_close">Zatvori</button>
  						  ...
  						  <div class="pass-reset">
						  	<button class="fake_link" id="pass-reset-btn" style="color:#337ab7;">Zaboravljen password?</button>
						  </div>
					</form>
				</div>
			</div>
