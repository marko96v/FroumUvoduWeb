			...
			<div class="users">
				...
				<div class="memberPrikaz">
						...
						<div style="float: left;">
							...
							<p class="membersInfo_other">Datum registracije: ${ requestScope.member.date }</p>
							<p class="membersInfo_other">Banovan: ${ requestScope.member.banned }</p>
						</div>
						...
						<div class="memberTopicsRepliesNum">
							...
							<form action="Search" method="post">
								...
								Teme: <input class="fake_link" type="submit" style="padding-bottom: 20px;" value="<%= topics.size() %>">
								</center>
							</form>
							...
							<form action="Search" method="post">
								...
								Poruke: <input class="fake_link" type="submit" style="padding-bottom: 20px;" value="<%= replies.size() %>">
								</center>
							</form>
