...
public class Forum extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("add".equals(method)){
			...
			if(addForumStatus == true){
				message = "Uspesno ste napravili nov forum!";
				status = "success";
			...
			if(editForumStatus == true){
				message = "Forum je uspesno izmenjen!";
				status = "success";
			...
			if(delForumStatus == true){
				message = "Uspesno ste obrisali forum!";
				status = "success";
			...
			if(lockForumStatus == true){
				message = "Uspesno ste zakljucali forum!";
				status = "success";
			...
			if(unlockForumStatus == true){
				message = "Uspesno ste otkljucali forum!";
				status = "success";
	...
	private boolean addForum(HttpServletRequest request, User user, ArrayList<User> users){
		...
		model.Forum forum = new model.Forum(name, desc, owner, type, parentForumId);
	...
	private boolean lockAllFankshn(int forumId, ArrayList<User> users){
		...
		ArrayList<model.Forum> subForums = ForumDAO.getSubForums(forumId, users);
		
		// za svaki forum ponovi ovaj fankshn
		for (model.Forum f : subForums) {
