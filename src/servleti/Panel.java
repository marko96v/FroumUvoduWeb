...
public class Panel extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (user == null) {
			request.setAttribute("message", "Potrebno je prvo da se ulogujete");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("editInfo".equals(method)){
			...
			if(editInfoStatus == true){
				message = "Uspesno ste izmenili podatke o korisniku!";
				status = "success";
			...
			if(editPassStatus == true){
				message = "Uspesno ste izmenili korisnikovu sifru!";
				status = "success";
			...
			if(passResetMemberStatus == true){
				message = "Uspesno resetovana lozinka!";
				status = "success";
			...
			if(banMemberStatus == true){
				if("true".equals(wut)){
					message = "Uspesno ste banovali clana!";
				}else{
					message = "Uspesno ste unbanovali clana!";	
				}
			...
			if(actMemberStatus == true){
				if("true".equals(wut)){
					message = "Uspesno ste aktivirali clana!";
				}else{
					message = "Uspesno ste deaktivirali clana!";	
				}
