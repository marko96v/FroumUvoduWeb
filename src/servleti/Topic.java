...
public class Topic extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("add".equals(action)){
			...
			if(addTopicStatus == true){
				message = "Nova tema je uspesno kreirana!";
				status = "success";
			...
			if(editTopicStatus == true){
				message = "Tema je uspesno izmenjena!";
				status = "success";
			...
			if(lockTopicStatus == true){
				message = "Tema je uspesno zakljucana!";
				status = "success";
			...
			if(unlockTopicStatus == true){
				message = "Tema je uspesno otkljucana!";
				status = "success";
			...
			if(delTopicStatus == true){
				message = "Tema je uspesno obrisana!";
				status = "success";
			...
			if(bookTopicStatus == true){
				message = "Tema je uspesno obelezena!";
				status = "success";
			...
			if(unbookTopicStatus == true){
				message = "Uspesno skinuto obelezje sa teme!";
				status = "success";
	...
	private boolean addTopic(HttpServletRequest request, User user, ArrayList<User> users){
		...
		model.Topic topic = new model.Topic(name, desc, content, owner, false, false, forumId);
	...
	private boolean editTopic(HttpServletRequest request, User user, ArrayList<User> users){
		...
		model.Topic topic = TopicDAO.getTopic(id, users);
